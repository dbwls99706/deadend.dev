...
def build_stylesheet() -> None:
    ...
    css = "\n".join([
        ...
        "  font-family: monospace; }",
        "",
        "/* Active search result (keyboard navigation) */",
        ".result-active { outline: 2px solid #58a6ff;",
        "  outline-offset: 2px;",
        "  border-radius: 6px; }",
        "",
        "/* Print stylesheet */",
        ...
        "  .skip-link, .copy-btn, .kbd-hint,",
        "  #search-input, .search-filters,",
        "  #all-errors, #recent-errors { display: none !important; }",
        "  .dead-end { border-left-color: #cc0000;",
        "    page-break-inside: avoid; }",
        "  .workaround { border-left-color: #008000;",
        "    page-break-inside: avoid; }",
        "  code { background: #f0f0f0; color: #000; }",
        "  #tldr { background: #f5f5f5 !important;",
        "    border-color: #ccc !important; }",
        "  .verdict-true { color: #008000; }",
        "  .verdict-partial { color: #cc6600; }",
        "  .verdict-false { color: #cc0000; }",
        "}",
        "",
    ])
